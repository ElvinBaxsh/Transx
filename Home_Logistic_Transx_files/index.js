!function () {
    ...
    const e = e => Math.abs(parseInt(e, 10)),
        t = (e, t) => {
            ...
            Array
                .from(r.values())
                .includes(t) || (t = `custom-${t = (t = t.replace(/[^0-9a-z]+/i, " ").trim()).replace(/\s+/, "-")}`);
        ...
        n = e => {
            ...
            return a.reduceRight(((e, t) => r => t(r, e)), (e => {
                ...
                "string" == typeof o && (n = r.replace(/^\/|\/$/g, ""), a = o.replace(/^\//, ""), s = a
                    ? n + "/" + a
                    : n),
    ...
    function c(e) {
        ...
        const o = {
            ...
            i = t => {
                ...
                t.idref
                    ? r.insertAdjacentHTML("beforeend", `<a href="#${t.idref}">${t.message}</a>`)
        ...
        l = (e, t) => {
            for (const r in t) {
                const n = t[r][0],
                    a = t[r][1];
                e
                    .querySelectorAll(`.wpcf7-form-control-wrap.${r}`)
                    .forEach((e => {
                        e
                            .querySelector(`input[name="${r}"]`)
                            .value = "",
                        e
                            .querySelector(".wpcf7-quiz-label")
                            .textContent = n,
                        e
                            .querySelector(`input[name="_wpcf7_quiz_answer_${r}"]`)
                            .value = a
                    }))
            }
        };
    function p(t) {
        ...
        t
            .querySelectorAll(".has-spinner")
            .forEach((e => {
                e.insertAdjacentHTML("afterend", '<span class="wpcf7-spinner"></span>')
            })),
        (e => {
            e
                .querySelectorAll(".wpcf7-exclusive-checkbox")
                .forEach((t => {
        ...
        (e => {
            e
                .querySelectorAll(".has-free-text")
                .forEach((t => {
        ...
        (e => {
            e
                .querySelectorAll(".wpcf7-validates-as-url")
                .forEach((e => {
                    e.addEventListener("change", (t => {
                        let r = e
                            .value
                            .trim();
                        r && !r.match(/^[a-z][a-z0-9.+-]*:/i) && -1 !== r.indexOf(".") && (r = r.replace(/^\/+/, ""), r = "http://" + r),
                        e.value = r
                    }))
                }))
        })(t),
        (e => {
            ...
            const t = () => {
                let t = !0;
                e
                    .querySelectorAll(".wpcf7-acceptance")
                    .forEach((e => {
