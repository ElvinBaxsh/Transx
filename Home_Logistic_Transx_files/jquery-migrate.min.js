...
function (t) {
    ...
    n.console && n.console.log && (s && e("3.0.0") || n.console.log("JQMIGRATE: jQuery 3.0.0+ REQUIRED"), s.migrateWarnings && n.console.log("JQMIGRATE: Migrate plugin loaded multiple times"), n.console.log("JQMIGRATE: Migrate is installed" + (s.migrateMute
        ? ""
        : " with logging active") + ", version " + s.migrateVersion));
    var r = {};
    function u(e) {
        var t = n.console;
    ...
    s.fn.removeAttr = function (e) {
        ...
        return s.each(e.match(v), function (e, t) {
            s
                ...
                .match
                .bool
                .test(t) && (u("jQuery.fn.removeAttr no longer sets boolean properties: " + t), r.prop(t, !1))
        }),
    ...
    var Q,
        b = !(s.fn.toggleClass = function (t) {
            return void 0 !== t && "boolean" != typeof t
                ...
                : (u("jQuery.fn.toggleClass( boolean ) is deprecated"), this.each(function () {
    ...
    s.fn.css = function (e, t) {
        ...
        return e && "object" == typeof e && !Array.isArray(e)
            ...
            : ("number" == typeof t && (r = j(e), n = r, w.test(n) && x.test(n[0].toUpperCase() + n.slice(1)) || s.cssNumber[r] || u('Number-typed values are deprecated for jQuery.fn.css( "' + e + '", value )')), Q.apply(this, arguments))
    };
    var A,
        k,
        S,
    ...
    s.each([
        ...
        s.fn[t] = function () {
            ...
            return "load" === t && "string" == typeof e[0]
                ? R.apply(this, e)
                : (u("jQuery.fn." + t + "() is deprecated"), e.splice(0, 0, t), arguments.length
    ...
    s.each(("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mous" +
            ...
            "ress keyup contextmenu").split(" "), function (e, r) {
        s.fn[r] = function (e, t) {
    ...
    s.fn.offset = function () {
        ...
        return !e || e.nodeType && e.getBoundingClientRect
            ...
            : (u("jQuery.fn.offset() requires a valid DOM element"), arguments.length
                ? this
                : void 0)
    },
