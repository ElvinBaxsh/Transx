    ...
    [
            ...
            class Alert extends elementorModules.frontend.handlers.Base {
                ...
                bindEvents() {
                    this
                        .elements
                        .$dismissButton
                        .on("click", this.onDismissButtonClick.bind(this))
                }
            ...
            class baseTabs extends elementorModules.frontend.handlers.Base {
                ...
                deactivateActiveTab(e) {
                    ...
                    n
                        .add(o)
                        .removeClass(s),
                    n.attr({tabindex: "-1", "aria-selected": "false", "aria-expanded": "false"}),
                    o[t.hideTabFn](),
                ...
                activateTab(e) {
                    ...
                    n[t.showTabFn](o, (() => elementorFrontend.elements.$window.trigger("resize"))),
                    n.removeAttr("hidden")
                }
                isActiveTab(e) {
                    return this
        ...
        5914: (e, t) => {
            ...
            class ImageCarousel extends elementorModules.frontend.handlers.SwiperBase {
                ...
                getSwiperSettings() {
                    ...
                    s
                        ? (o.effect = e.effect, "fade" === e.effect && (o.fadeEffect = {
                            crossFade: !0
                        }))
                ...
                onEditSettingsChange(e) {
                    "activeItemIndex" === e && this
                        .swiper
                        .slideToLoop(this.getEditSettings("activeItemIndex") - 1)
                }
            }
            ...
            class TextEditor extends elementorModules.frontend.handlers.Base {
                ...
                wrapDropCap() {
                    if (!this.getElementSettings("drop_cap")) 
                        return void(this.dropCapLetter && (this.elements.$dropCap.remove(), this.elements.$paragraph.prepend(this.dropCapLetter), this.dropCapLetter = ""));
        ...
        5363: (e, t) => {
            ...
            class Video extends elementorModules.frontend.handlers.Base {
                ...
                handleVideo() {
                    this.getElementSettings("lightbox") || ("youtube" === this.getElementSettings("video_type")
                ...
                playVideo() {
                    ...
                    const s = e[0]
                        .src
                        .replace("&autoplay=0", "");
                    if (e[0].src = s + "&autoplay=1", e[0].src.includes("vimeo.com")) {
                        const t = e[0].src,
                            s = /#t=[^&]*/.exec(t);
                        e[0].src = t.slice(0, s.index) + t.slice(s.index + s[0].length) + s[0]
                    }
                }
                async animateVideo() {
                ...
                prepareYTVideo(e, t) {
                    const s = this.getElementSettings(),
                        i = {
                            ...
                            events: {
                                ...
                                onStateChange: t => {
                                    t.data === e.PlayerState.ENDED && s.loop && this
                                        .youtubePlayer
                                        .seekTo(s.start || 0)
                                }
                            },
                            playerVars: {
                                ...
                                rel: s.rel
                                    ? 1
                                    : 0,
                                playsinline: s.play_on_mobile
                                    ? 1
                                    : 0,
                                modestbranding: s.modestbranding
                                    ? 1
                                    : 0,
                                autoplay: s.autoplay
                                    ? 1
                    ...
                    s.yt_privacy && (i.host = "https://www.youtube-nocookie.com", i.origin = window.location.hostname),
                ...
                bindEvents() {
                    this
                        .elements
                        .$imageOverlay
                        .on("click", this.handleVideo.bind(this))
                }
                onInit() {
                    super.onInit();
                    const e = this.getElementSettings();
                    if ("youtube" === e.video_type && (this.apiProvider = elementorFrontend.utils.youtube, this.videoID = this.apiProvider.getVideoIDFromURL(e.youtube_url), this.videoID && (!e.show_image_overlay || !e.image_overlay.url))) 
                        return e.lazy_load
                            ...
                            : void(elementorFrontend.config.experimentalFeatures.e_optimized_assets_loading
                                ...
                                : setTimeout((() => {
                                    this
                                        .apiProvider
                                        .onApiReady((e => this.prepareYTVideo(e)))
                                }), 0))
                        }
                onElementChange(e) {
                ...
                .extend({
                    ...
                    showModal: function (e) {
                        if (e.url && !e.url.startsWith("http")) 
                            return;
                        this.elements.$closeButton = this
                            .getModal()
                            .getElements("closeButton"),
                    ...
                    createLightbox: function (e) {
                        let t = {};
                        if (e.dataset.elementorLightbox && (t = JSON.parse(e.dataset.elementorLightbox)), t.type && "slideshow" !== t.type) 
                    ...
                    setHTMLContent: function (e) {
                        window.elementorCommon && elementorCommon
                            .helpers
                            .hardDeprecated("elementorFrontend.utils.lightbox.setHTMLContent", "3.1.4"),
                        this
                            .getModal()
                            .setMessage(e)
                    },
                    ...
                    createShareLink: function (e, t) {
                        const s = {};
                        if ("pinterest" === e) 
                            s.image = encodeURIComponent(t);
                        else {
                            const e = elementorFrontend
                                .utils
                                .urlActions
                                .createActionHash("lightbox", {
                                    id: this.id,
                                    url: t
                                });
                    ...
                    getSlideshowHeader: function () {
                        ...
                        if (s || i || n || o) {
                            if (l.$header = t("<header>", {
                                ...
                                l
                                    .$header
                                    .append(l.$iconShare, l.$shareMenu),
                                this.$buttons = this
                                    .$buttons
                                    .add(l.$iconShare)
                            }
                            return n && (l.$iconZoom = t("<i>", {
                                ...
                                "aria-checked": !1,
                                "aria-label": e.zoom
                            }), l.$iconZoom.on("click", this.toggleZoomMode), l.$header.append(l.$iconZoom), this.$buttons = this.$buttons.add(l.$iconZoom)),
                            i && (l.$iconExpand = t("<i>", {
                                class: r.iconExpand,
                                role: "switch",
                                "aria-checked": !1,
                                "aria-label": e.fullscreen
                            }).append(t("<span>"), t("<span>")), l.$iconExpand.on("click", this.toggleFullscreen), l.$header.append(l.$iconExpand), this.$buttons = this.$buttons.add(l.$iconExpand)),
                    ...
                    activateShareMode: function () {
                        ...
                        this
                            .elements
                            .$container
                            .addClass(e.slideshow.shareMode),
                        this
                            .elements
                            .$iconShare
                        ...
                        this.$buttons = this
                            .elements
                            .$iconShare
                            .add(this.elements.$shareMenu.find("a")),
                        this.shareMode = !0
                    },
                    deactivateShareMode: function () {
                        ...
                        this
                            .elements
                            .$container
                            .removeClass(e.slideshow.shareMode),
                        this
                            .elements
                            .$iconShare
                    ...
                    activateFullscreen: function () {
                        ...
                        i
                            .default
                            .request(this.elements.$container.parents(".dialog-widget")[0]),
                        this
                            .elements
                            .$iconExpand
                        ...
                        this
                            .elements
                            .$container
                            .addClass(e.slideshow.fullscreenMode)
                    },
                    deactivateFullscreen: function () {
                        ...
                        this
                            .elements
                            .$container
                            .removeClass(e.slideshow.fullscreenMode)
                    },
                    ...
                    deactivateZoom: function () {
                        ...
                        t
                            .$container
                            .removeClass(s.slideshow.zoomMode),
                        t
                            .$iconZoom
                    ...
                    setSlideshowContent: function (e) {
                        ...
                        e
                            ...
                            .forEach((e => {
                                ...
                                if (e.video) {
                                    ...
                                    const i = s("<div>", {class: r.playButton}).html(s("<i>", {
                        ...
                        }).html(s("<i>", {class: l.prevButtonIcon})), u = s("<div>", {
                            class: l.nextButton + " " + r.preventClose,
                            "aria-label": t.next
                        }).html(s("<i>", {class: l.nextButtonIcon})), d.append(u, h), this.$buttons = this.$buttons.add(u).add(h)),
                    ...
                    showLightboxUi: function () {
                        ...
                        this
                            .elements
                            .$container
                            .removeClass(e.hideUiVisibility),
                        clearTimeout(this.getSettings("hideUiTimeout")),
                        this.setSettings("hideUiTimeout", setTimeout((() => {
                            this.shareMode || this
                                .elements
                                .$container
                                .addClass(e.hideUiVisibility)
                        }), 3500))
                    },
                    ...
                    updateFooterText: function () {
                        ...
                        const e = this.getSettings("classes"),
                            t = this
                                .getSlide("active")
                                .find(".elementor-lightbox-image"),
                            s = t.data("title"),
                            i = t.data("description"),
                            n = this
                                .elements
                                .$footer
                                .find("." + e.slideshow.title),
                            o = this
                                .elements
                                .$footer
                                .find("." + e.slideshow.description);
                        n.text(s || ""),
                        o.text(i || "")
                    },
                    playSlideVideo: function () {
                        ...
                        -1 !== t.indexOf("vimeo.com")
                            ...
                            : t.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && (a = "youtube", r = elementorFrontend.utils.youtube);
                    ...
                    openSlideshow: function (e, t) {
                        const s = jQuery(this.getSettings("selectors.links")).filter(((t, s) => {
                                const i = jQuery(s);
                                return e === s.dataset.elementorLightboxSlideshow && !i
                                    .parent(".swiper-slide-duplicate")
                                    .length && !i
                                    .parents(".slick-cloned")
                                    .length
                            })),
                            i = [];
                        let n = 0;
